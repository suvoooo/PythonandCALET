...
savefigpath = '/home/suvo/Downloads/Analysis/CALETfit/plot/checktwop/tryexpect/bplawandpulsar/fixEpulcut/checksolmod/checksmoo/fixbreakenergy/finebreaken/finalfits/newfiles/'

#smooth = input("s value:")
#pot = input("phi value:")
...
def sourceparam(ce,ge,ratpe,indpul,phi,Epn,Epul):
	sE = Epul + phi
	sourceflux = (ce * ((sE)**(-ge)) ) * (ratpe * (sE**(indpul))) * math.exp(-sE/Epn)
...
m.values['ge'] = 3.2293740881405273
#m.limits['ge'] = (2.5,4)
m.fixed['ge']=True
